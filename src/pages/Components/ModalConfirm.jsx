...
const ModalConfirm = ({ isOpen, openModal, onTrue, onFalse, title, message, trueText, falseText }) => {
    const close = () => {
        openModal(false);
                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    >
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                <div
                                    ...
                                    bg-blue-200 sm:mx-0 sm:size-10`}
                                >
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    >
                                        {title != null ? title : "Confirm Action"}
                                    </DialogTitle>
                                    <div className="mt-2">
                        ...
                        <div className="bg-gray-200 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button
                                type="button"
                                className={`inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2 text-sm
                                font-semibold text-white shadow-xs hover:bg-blue-500 sm:ml-3 sm:w-auto cursor-pointer`}
                                onClick={() => {
                                    if (onTrue != null) {
                                        onTrue();
                                    }
                            ...
                            >
                                {(trueText !== null && trueText !== undefined) ? trueText : "OK"}
                            </button>
                            <button
                                type="button"
